...
/* harmony import */ var _util_util__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(434);
/* harmony import */ var _scss_message_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(487);
/* harmony import */ var _scss_message_scss__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_scss_message_scss__WEBPACK_IMPORTED_MODULE_8__);
...
var Message = function (_Component) {
    babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(Message, _Component);

    function Message(props) {
        babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, Message);

        var _this = babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3___default()(this, (Message.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_0___default()(Message)).call(this, props));
        ...
        if (typeof PRELOAD_STATE !== 'undefined') {
            _this.state.msgs = PRELOAD_STATE;
            // 清除
            PRELOAD_STATE = null;
            document.getElementById('preload-state').remove();
        } else {
            _this.state.msgs = _this.props.preloadState;
        }
    ...
    babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Message, [{
        ...
        key: 'msgRead',
        value: function msgRead(id, e) {
            var msgs = this.state.msgs;
            var itemIndex = msgs.findIndex(function (item) {
                return item.id === id;
            });
        ...
        value: function render() {
            ...
            return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(
                ...
                react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(
                    'div',
                    { className: 'msg-items' },
                    this.state.msgs.map(function (item) {
                        return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(
                            'div',
                            { key: item.id, className: 'msg-item' },
                            react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(
                                'p',
                                { className: 'msg-item__header' },
                                item.userName,
                                ' - ',
                                item.time
                            ),
                            react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(
                                'p',
                                { className: 'msg-item__content' },
                                item.content
                            ),
                            react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(
                                'a',
                                { href: 'javascript:;', className: 'msg-item__read', onClick: _this2.msgRead.bind(_this2, item.id) },
                                '\xD7'
                            )
                        );
                    })
...
/* harmony import */ var _common_message__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(458);
...
function init(preloadState) {
    return ReactDOMServer.renderToString(React.createElement(_common_message__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"], { preloadState: preloadState }));
...
// module
exports.push([module.i, "body{margin:0;padding:0;background:#f8f8f8;font-size:14px;font-family:Microsoft YaHei;line-height:1.5;color:#333}#content{margin:20px auto;min-width:500px;width:60%;background-color:#fff;border-radius:3px;box-shadow:0 0 20px #ddd}#content h4{margin-bottom:0;padding:20px;text-align:center}.msg-items{overflow:auto;padding-bottom:30px;height:600px}.msg-item{position:relative;padding:20px;border-bottom:1px solid #f5f5f5}.msg-item:first-child{border-top:1px solid #f5f5f5}.msg-item:hover{background:#f5f5f5}.msg-item__header{color:#999}.msg-item__content{max-width:90%}.msg-item__read{position:absolute;top:50%;right:30px;margin-top:-30px;font-size:40px;color:#ddd!important;text-decoration:none!important}.msg-item__read:hover{color:#aaa!important}", ""]);
